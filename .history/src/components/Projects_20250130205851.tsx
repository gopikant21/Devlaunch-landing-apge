  ...
  return (
    ...
    >
      ...
      <motion.div className="relative">
        ...
        >
          <span className={`absolute inset-0 bg-gradient-to-r ${project.gradient} opacity-20`} />
          <span className="absolute inset-0 bg-gray-900 opacity-80 group-hover/button:opacity-0 transition-opacity duration-500" />
          <span className={`absolute inset-[1px] rounded-xl bg-gray-900 group-hover/button:bg-${project.accentColor}/10 transition-colors duration-500`} />

  ...
  return (
    ...
    >
      ...
      <motion.div className="relative">
        ...
        {/* Title */}
        <motion.h3
          className={`text-xl font-bold mb-4 text-gray-100 group-hover:text-${service.accentColor}`}
        >
          {service.title}
        </motion.h3>

        {/* Description */}
        <motion.p className="text-gray-400 mb-6 line-clamp-2 group-hover:text-gray-300 transition-colors duration-300">
          {service.description}
        </motion.p>
        ...
        >
          ...
          />
          <motion.span className="relative text-sm font-medium text-gray-200">
            Learn More
          </motion.span>
        </motion.button>
      </motion.div>

  ...
  return (
    ...
    >
      ...
      <motion.div className="relative">
        ...
        >
          <motion.div className="w-full h-full bg-gray-900 rounded-2xl flex items-center justify-center">
            <motion.span
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{
        ...
        {/* Title */}
        <motion.h3
          className={`text-xl font-bold mb-4 text-gray-100 group-hover:text-${service.accentColor} font-outfit tracking-tight`}
        >
          {service.title}
        </motion.h3>
          ...
          {service.features.map((feature, i) => (
            ...
            >
              <motion.div
                ...
                className={`w-5 h-5 rounded-full bg-${service.accentColor}/10 mr-3 flex-shrink-0 flex items-center justify-center border border-${service.accentColor}/20`}
              >
                <motion.svg
        ...
        >
          ...
          />
          <motion.span className="relative text-sm font-medium text-gray-200 tracking-wider-plus uppercase">
            Learn More
          </motion.span>
        </motion.button>
      </motion.div>
    ...
    <section className="py-20 px-4 bg-gray-800 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <motion.div className="text-center mb-16">
          <motion.h2 className="text-4xl md:text-5xl font-bold mb-4 text-white/90 font-outfit tracking-tight">
            Our Services
          </motion.h2>

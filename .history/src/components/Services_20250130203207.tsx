...
const ServiceCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover={{ y: -5 }}
      className="group relative bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 hover:shadow-2xl hover:shadow-fuchsia-500/10 transition-all duration-300 overflow-hidden border border-gray-800/50"
    >
      ...
      <motion.div
        ...
        className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-white/10 to-transparent rounded-bl-full"
      />
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6, delay: 0.3 }}
        className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-white/10 to-transparent rounded-tr-full"
      />
      ...
      >
        ...
        <motion.div
          ...
          className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${service.gradient} p-[2px] mb-6 transform group-hover:scale-110 transition-transform duration-300`}
        >
          <motion.div
        ...
        <motion.h3
          ...
          className="text-2xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-gray-100 to-gray-300 group-hover:from-white group-hover:to-gray-200 transition-all duration-300"
        >
          {service.title}
        </motion.h3>
          ...
          {service.features.map((feature, i) => (
            ...
            >
              <motion.div
                ...
                className={`w-6 h-6 rounded-full bg-gradient-to-r ${service.gradient} p-[1px] mr-3 flex-shrink-0`}
              >
        ...
        >
          <motion.span
            ...
            whileHover={{ x: "0%" }}
            transition={{ duration: 0.3 }}
            className="absolute inset-0 rounded-xl bg-gray-900 opacity-0 group-hover/button:opacity-95"
          />
          <motion.span
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-violet-500 to-fuchsia-500 px-8 py-3 rounded-full text-lg font-medium hover:opacity-90 transition-opacity"
          >
            Contact Us
          </motion.button>
        </motion.div>

  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="text-2xl font-bold mb-4 group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-300 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
          {service.title}
        </h3>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className={`w-full py-3 rounded-xl bg-gradient-to-r ${service.gradient} relative group/button`}
        >
          <span className="absolute inset-0 rounded-xl bg-gray-900 opacity-0 group-hover/button:opacity-90 transition-opacity duration-300" />
          <span className="relative text-sm font-medium">Learn More</span>
        </motion.button>
      </div>
    </motion.div>
  );

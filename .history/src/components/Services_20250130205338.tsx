  ...
  return (
    ...
    >
      ...
      <motion.div className="relative">
        ...
        {/* Title */}
        <motion.h3
          className={`text-xl font-clash font-semibold mb-4 text-gray-100 group-hover:text-${service.accentColor} tracking-tighter`}
        >
          {service.title}
        </motion.h3>
        ...
        <ul className="space-y-3 mb-8">
          {service.features.map((feature, i) => (
            ...
            >
              ...
              <span className="text-sm tracking-normal">{feature}</span>
            </motion.li>
          ))}
        </ul>
